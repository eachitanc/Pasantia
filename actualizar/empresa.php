...
$obj = $rs->fetch();
include '../navbar.php'?>
                <h3 class="text-md-center p-2">Actulizar Empresa</h3>
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <input type="text" class="form-control" id="txtApellido1" name="txtApellido1" value="" placeholder="Primer Nombre">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control" id="txtApellido2" name="txtApellido2" value="" placeholder="Segundo Nombre">
                                    </div>
                                </div>
                            </div>
                        </div>
